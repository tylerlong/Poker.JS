...
(function () {
  if (window.CanvasRenderingContext2D) {
    ...
    const o = function (z) {
      const y = arguments.callee.caller.arguments;
      return y[0] + (z * y[2]) / p;
    };
    const m = function (z) {
      const y = arguments.callee.caller.arguments;
    ...
    const a = function (z) {
      const y = d.createElement('canvas');
      y.height = z;
      y.width = (z * 3) / 4;
      return y;
    };
    ...
    c.drawPokerCard = function (A, G, B, C, z) {
      const D = this;
      const F = D.fillPokerSymbol;
      const E = D.drawPokerCrown;
      C = w(C);
      z = i(z);
          ...
          : E === 'L'
            ...
            : E === 'H'
              ...
              : E === 'V'
                ? B.lineTo(G, K(D[1]))
                : E === 'C'
                  ? B.bezierCurveTo(z(D[1]), K(D[2]), z(D[3]), K(D[4]), z(D[5]), K(D[6]))
    ...
    c.drawPokerCrown = function (H, F, I, E, D, B) {
      const z = this;
      const C = z.fillPokerSymbol;
      const A = z.fillRoundRect;
      let G;
      E = E || r;
      D = D || q;
      B = B || '#fff';
